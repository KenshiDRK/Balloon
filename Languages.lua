...
["catalan"] = {name = "Català", code = "ca", articles = {singular = {masc = "el", fem = "la"}, plural = {masc = "els", fem = "les"}}},
["galician"] = {name = "Galego", code = "gl", articles = {singular = {masc = "o", fem = "a"}, plural = {masc = "os", fem = "as"}}},
